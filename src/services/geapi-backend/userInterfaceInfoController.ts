...
export async function getUserInterfaceInfoByIdUsingGET(
  ...
  return request<API.BaseResponseUserInterfaceInfo_>('/api/userUserInterfaceInfo/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listUserInterfaceInfoUsingGET(
  ...
  return request<API.BaseResponseListUserInterfaceInfo_>('/api/userUserInterfaceInfo/list', {
    method: 'GET',
    params: {
      ...params,
    },
